...
@Entity("sms_outbox", { schema: "fuelrod" })
export class SmsOutbox {
  ...
  @ManyToOne(
    () => MobileNetwork,
    (mobileNetwork) => mobileNetwork.smsOutboxes,
    { onDelete: "RESTRICT", onUpdate: "CASCADE" }
  )
  @JoinColumn([{ name: "network_code", referencedColumnName: "mccRef" }])
  networkCode2: MobileNetwork;
}
